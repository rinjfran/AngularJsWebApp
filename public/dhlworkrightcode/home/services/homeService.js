...
app.factory('homeService',function($q,$http,$rootScope){
  return {
    ...
    getHighPerformanceActivities:function(){
      ...
      $http({
      method: 'GET',
       url:'https://dhl-productivity-poc-api.mybluemix.net:443/activities?is_running=true&rank=good',
       headers:{"Authorization":"Basic"+' '+encodedstring}
       }).then(function successCallback(response) {
            deferred.resolve(response);
          },function errorCallback(failureResponse){
    ...
    getLowPerformanceActivities:function(){
      ...
      $http({
      method: 'GET',
       url:'https://dhl-productivity-poc-api.mybluemix.net:443/activities?is_running=true&rank=bad',
       headers:{"Authorization":"Basic"+' '+encodedstring}
       }).then(function successCallback(response) {
            deferred.resolve(response);
          },function errorCallback(failureResponse){
